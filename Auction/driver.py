...
with open ("/home/george/Desktop/logs/server.out", 'w') as fd: 
  with open ("/home/george/Desktop/logs/server.err", 'w') as fd2: 
    subprocess.Popen(["java", "ServerLauncher", "/home/george/Desktop/input.txt"], stdout = fd, stderr = fd2)
...
for i in msgList:
  ...
  last_time = i[0]
  if i[2] == "launch":
    with open ("/home/george/Desktop/logs/{0}@localhost:{1}.out".format(i[1], ports[i[1]]), 'w') as fd: 
      with open ("/home/george/Desktop/logs/{0}@localhost:{1}.err".format(i[1], ports[i[1]]), 'w') as fd2:
        bidder[i[1]] = subprocess.Popen(
                         ["java", "ClientLauncher", "192.168.1.71", ports[i[1]], i[1]],
